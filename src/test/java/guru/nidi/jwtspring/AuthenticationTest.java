...
//        registerUser("john", "password").andExpect(status().isCreated());
//    }
//
//    @Test
...
//        final String token = extractToken(login("john", "password").andReturn());
...
//    }
    ...
    public void loginOk() throws Exception {
        login("john", "password")
                ...
                .andExpect(jsonPath("$.user.username", equalTo("john")))
...
//        login("john", "wrong").andExpect(status().isForbidden());
//    }
